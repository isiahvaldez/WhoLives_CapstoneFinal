...
function loadInventoryList() {
    dataTable = $('#DT_load_inventory').DataTable({
        ...
        "columns": [
            ...
            { "data": "totalLooseQty", "width": "25%", "defaultContent": "<i>Not set</i>" },
            { "data": "totalLooseQty", "width": "25%", "defaultContent": "<i>Not set</i>" }, // change this to include items in assemblies later - IV 4/3/2020 
            { "data": "totalLooseQty", "width": "25%", "defaultContent": "<i>Not set</i>" } // this needs to be the number required for the drill - IV 4/3/2020
        ],
        "language": {
